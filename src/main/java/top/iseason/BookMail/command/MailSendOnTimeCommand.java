...
public class MailSendOnTimeCommand extends SimpleSubCommand {
    ...
    public static void sendOnce(Player player, String[] args) {
        ...
        new BukkitRunnable() {
            ...
            public void run() {
                ...
                if(TimeManager.addOnceOnTimeTask(mail.groupID,args[2],"once",time))
    ...
    private static Boolean checkPeriodType(String arg) {
        ...
        Matcher matcher2 = Pattern.compile("month:(\\d*)").matcher(arg);
    ...
    private static void showHelp(Player player) {
        ...
        helpMessage.add("&6可选&a: &c online/offline/register/loginTime[参数]");
